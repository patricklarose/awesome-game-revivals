...
- **[OpenTTD](https://www.openttd.org/)** - Open-source Transport Tycoon Deluxe
- **[OpenSC2K](https://github.com/nicholas-ochoa/OpenSC2K)** - Open-source SimCity 2000
- **[OpenGOAL](https://opengoal.dev/)** - Native Jak and Daxter port
- **[Clone Hero](https://clonehero.net/)** - Guitar Hero clone
- **[Meridian 59](https://www.meridian59.com/)** - Open-source Meridian 59
...
- **[reTHAWed](https://rethawed.com/)** - Tony Hawk's American Wasteland mod
...
- **[ScummVM](https://www.scummvm.org/)** - Point-and-click adventure game emulator
...
- **[RPCS3](https://rpcs3.net/)** - Open-source PlayStation 3 emulator
- **[Xenia](https://xenia.jp/)** - Open-source Xbox 360 emulator
- **[RetroArch](https://www.retroarch.com/)** - Emulator frontend
- **[EmuVR](https://www.emuvr.net/)** - VR retro game interface